...
<head>
    ...
    <script type="text/javascript">
        var url =  '<%=session.getAttribute("influence")%>_login';
...
<div class="row-fluid">
    <div class="dialog">
        <div class="block">
            <br>
            <p style="text-align: center;font-size: 16px;color: #337ab7;">密码已更新，3秒后自动跳转至登录页面</p>
            <input id="url" type="hidden" value="${sessionScope.influence}_login">
            <br>
        </div>
    </div>
</div>
